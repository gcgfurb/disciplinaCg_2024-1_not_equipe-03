...
namespace gcgcg
{
    public class Mundo : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            GL.ClearColor(145.0f/255.0f, 129.0f/255.0f, 156.0f/255.0f, 1.0f);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                // primeiros passos SrPalito
                                if (objetoSelecionado != null && objetoSelecionado is SrPalito)
                                {
                                    var srPalito = (SrPalito)objetoSelecionado;
                                    if (input.IsKeyDown(Keys.Q))
                                    {
                                        srPalito.Andar(-0.0005); 
                                    }
