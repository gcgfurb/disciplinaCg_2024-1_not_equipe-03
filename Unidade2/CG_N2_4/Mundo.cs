...
namespace gcgcg
{
    public class Mundo : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            GL.ClearColor(125.0f/255.0f, 158.0f/255.0f, 127.0f/255.0f, 1.0f);
            ...
            #region Objeto: Spline
             objetoSelecionado = new Spline(mundo, rotuloAtual);
             #endregion
        }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (input.IsKeyPressed(Keys.J))
                            {
                                ...
                                if (objetoSelecionado != null && objetoSelecionado is Spline)
                                {
